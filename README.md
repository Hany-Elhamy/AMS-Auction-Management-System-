...
Note: you will run each folder separately and install node_module for each folder and in the back-end folder search for file.env change name of database and port
