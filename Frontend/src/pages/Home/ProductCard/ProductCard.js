...
export const ProductCard = ()=>{
  ...
  // const [specificProductCard, setSpecificProductCard] = useState({
  //   loading: true,
  //   result: {},
  //   err: null,
  // });
  ...
  //     .then((data) => {
  //       setAuction({ ...auction, result: data.data, loading: false, err: null });
  //       console.log(data.data);
  //     })
  //     .catch((err) => {
  //       setAuction({ ...auction, loading: false, err: [{ msg: `something went wrong ${err}` }] });
  //     });
  // }, []);
  ...
  <div    className="flip-card-inner" >
    ...
    <div  className="flip-card-back popup" >
      ...
      <p><strong>Duration : </strong>{productCard.duration} Days</p>
